...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <p>
        <span className="italic">When I'm not coding</span>, I enjoy spending time with my family, hiking, and playing football. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning{" "}
        <span className="font-medium">Vue.js and German language</span>. I'm also
